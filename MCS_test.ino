...
#define WIFI_AP "Trial"
#define WIFI_PASSWORD "12345678"
#define WIFI_AUTH LWIFI_WPA  // choose from LWIFI_OPEN, LWIFI_WPA, or LWIFI_WEP.
#define per 50
#define per1 3
#define DEVICEID "D6Tp1e0v" // Input your deviceId
#define DEVICEKEY "aBHnTt7l00cmzczE" // Input your deviceKey
...
String upload_led;
String tcpcmd_led_on = "switch,1";
String tcpcmd_led_off = "switch,0";
